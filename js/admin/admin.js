...
function searchVehiclesForAdmin(vehicleType){
    ...
    fetch("../../php/adminSearch.php", {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            + "<div id='update_"+data[i]._id.$oid+"' class='updateVehicles offset-2 col-1 me-4 btn btn-success'><svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' class='bi bi-pencil' viewBox='0 0 16 16'>"
        ...
        for(let element of deleteElements) {
            element.addEventListener("click",()=>{
                console.log(element.id, vehicleType)
